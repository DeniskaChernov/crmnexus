...
export const CRM_AI_WELCOME =
  "👋 Я CRM-аналитик BTT Nexus. Помню историю нашего диалога и вижу, в каком разделе вы сейчас работаете.\n\n" +
  "Могу разобрать воронку, сделки, задачи, склад и производство на основе живых данных CRM.\n\n" +
  "С чего начнём?";
