...
ALTER TABLE companies ADD COLUMN IF NOT EXISTS dealer_portal_enabled BOOLEAN NOT NULL DEFAULT false;

ALTER TABLE deals ADD COLUMN IF NOT EXISTS dealer_id UUID REFERENCES companies(id) ON DELETE SET NULL;
